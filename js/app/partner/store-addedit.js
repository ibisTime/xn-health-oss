$(function() {
    ...
    var fields = [{
        ...
        onChange:function(v,data){
            if ($("#dvalue_chosen .chosen-single span").text()=="酒店名宿") {
                // $("#dvalue_chosen .chosen-single span").attr("data-chosen-select","2")
                 // $("#category_chosen .chosen-single span").hide();
                 // $("#type_chosen .chosen-single span").hide();
                 $("#category_chosen").parent(".clearfix").hide();
                 $("#type_chosen").parent(".clearfix").hide();
            }else{
                // $("#category_chosen .chosen-single span").empty();
                //  $("#type_chosen .chosen-single span").empty();
